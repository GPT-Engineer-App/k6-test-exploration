...
const CareTips = () => (
  <div className="space-y-4">
    ...
    <ul className="list-disc pl-5 space-y-2">
      ...
      <li>Ensure your dog gets regular exercise through walks, playtime, and mental stimulation.</li>
      <li>Schedule regular check-ups with your veterinarian for vaccinations and health screenings.</li>
